...
LIBARIBCC_WITH_GDI_FONT = 0
else
LIBARIBCC_WITH_DIRECTWRITE = 0
LIBARIBCC_WITH_GDI_FONT = 1
endif
else
...
LIBARIBCC_CONF += -DARIBCC_USE_DIRECTWRITE:BOOL=OFF
endif

ifeq ($(LIBARIBCC_WITH_GDI_FONT), 1)
LIBARIBCC_CONF += -DARIBCC_USE_GDI_FONT:BOOL=ON
else
LIBARIBCC_CONF += -DARIBCC_USE_GDI_FONT:BOOL=OFF
endif
