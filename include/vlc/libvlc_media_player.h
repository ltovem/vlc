 ...
 * can be passed to \ref libvlc_video_output_mouse_press_cb, \ref libvlc_video_output_mouse_release_cb,
 * and \ref libvlc_video_output_mouse_double_click_cb
 */
...
/** Callback type that can be called to notify when a mouse button is double clicked in the rendering surface.
 *
 * libvlc will provide a callback of this type when calling \ref libvlc_video_output_set_window_cb.
 *
 * the button event will be reported at the last position provided by \ref libvlc_video_output_mouse_move_cb
 *
 * \param report_opaque parameter passed to \ref libvlc_video_output_set_window_cb. [IN]
 * \param button represent the button double clicked, see \ref libvlc_video_output_mouse_button_t for available buttons. [IN]
 */
typedef void (*libvlc_video_output_mouse_double_click_cb)(void *opaque, libvlc_video_output_mouse_button_t button);
 ...
 *            The position of the event is the last position reported by the report_mouse_move callback. This may be
 *            called from any thread.
 * \param[in] report_mouse_double_click callback which must be called when a mouse button is double clicked on
 *            the video surface, The position of the event is the last position reported by the
 *            report_mouse_move callback. This may be called from any thread.
...
typedef void( *libvlc_video_output_set_window_cb )( void *opaque,
                                            ...
                                            libvlc_video_output_mouse_double_click_cb report_mouse_double_click,
                                            void *report_opaque );
