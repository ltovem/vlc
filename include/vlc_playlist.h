 ...
 */
#define VLC_PLAYLIST_SCOPE_FLAG_NONE           (0U)
#define VLC_PLAYLIST_SCOPE_FLAG_LOCAL          (1U << 0)
#define VLC_PLAYLIST_SCOPE_FLAG_NETWORK        (1U << 1)
#define VLC_PLAYLIST_SCOPE_FLAG_ANY            (VLC_PLAYLIST_SCOPE_FLAG_LOCAL|\
                                                VLC_PLAYLIST_SCOPE_FLAG_NETWORK)
#define VLC_PLAYLIST_SCOPE_FLAG_INTERACTIVE    (1U << 2)
 ...
 * \param flags media preparse scope as VLC_PLAYLIST_SCOPE_FLAG
 */
VLC_API void
