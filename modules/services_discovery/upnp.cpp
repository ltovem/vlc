...
vlc_module_begin()
    ...
    add_submodule()
        ...
        add_integer_with_range(SOUT_CFG_PREFIX "port", 0, 0, 65535, PORT_TEXT, PORT_LONGTEXT)
        add_integer_with_range(SOUT_CFG_PREFIX "http-port", HTTP_PORT, 1, 65535, HTTP_PORT_TEXT, HTTP_PORT_LONGTEXT)
