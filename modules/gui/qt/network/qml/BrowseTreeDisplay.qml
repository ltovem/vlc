...
MainInterface.MainViewLoader {
    ...
    Component {
        ...
        BrowseAuxillaryView {
            auxillaryView: Widgets.EmptyLabelButton {
                id: emptyLabel
    ...
    component BrowseAuxillaryView : FocusScope {
        required property Item auxillaryView
        ...
        property int focusReason: (header.activeFocus) ? header.focusReason
                                                       : Helpers.get(auxillaryView, "focusReason", Qt.NoFocusReason)
        ...
        onAuxillaryViewChanged: {
            if (layout.children.length === 2)
                layout.children.pop()

            layout.children.push(auxillaryView)
            auxillaryView.Navigation.upAction = function () {
        ...
        ColumnLayout {
            ...
            BrowseTreeHeader {
                ...
                Navigation.parentItem: root
                Navigation.downItem: (auxillaryView.Navigation.navigable) ? auxillaryView : null
            }
        }
    }
}
